...
<img class="img-responsive" src="{{ site.url }}{{ site.baseurl }}/images/logopic/Innovation_at_nexus.png" style="float: left; width: 300px; margin: 0 15px 10px 0;"/>
...
<img class="img-responsive" src="{{ site.url }}{{ site.baseurl }}/images/logopic/physics_to_engineering.png" style="float: left; width: 300px; margin: 0 15px 10px 0;"/>
